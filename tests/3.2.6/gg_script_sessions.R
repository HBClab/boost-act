...
# Usage: Rscript new_gg.R --project_dir "/Shared/vosslabhpc/Projects/BOOST/ObservationalStudy/3-experiment/data/act-obs-test/" --deriv_dir "derivatives/GGIR-3.2.6-test/"
library(tidyr)
library(plyr)
library(optparse)
library(GGIR)
